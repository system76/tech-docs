...
This page uses photos of the original `launch_heavy_3` revision, which ships with cream-colored keycaps and a grey power coat finish. For the newer black revision of this model, see the [launch_heavy_3b](../launch_heavy_3b/specs.md).
