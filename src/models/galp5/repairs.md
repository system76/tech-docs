...
1. Remove the 13 bottom panel screws.
  - The two slightly larger screws (highlighted cyan below) go in the back corners, next to the hinges.
...
3. Unplug the white fan connector, highlighted cyan above. Remove any clear tape that may be holding the wires in place.
4. Remove the fan from the system.

### Steps to replace the heatsink/thermal paste:

1. Follow the steps above to [remove the bottom cover](#removing-the-bottom-cover).
2. Remove the eight heatsink screws (highlighted red above) in order, starting with #1, then #2, and continuing until #8.
...
5. After cleaning the CPU and heatsink, apply a small line of thermal paste directly onto the CPU/GPU chips.

![Thermal paste application](./img/thermal-paste-application.jpg)

6. Carefully replace the heatsink.
7. Replace the three heatsink screws, starting with #1, then #2, and continuing until #8.
