# Lemur Pro 9 (Parts & Repairs)

Many components on your Lemur Pro can be upgraded or replaced as necessary. Follow these step-by-step guides for instructions:
...
1. Place the Lemur lid-side-down.
2. Remove the 2 keyboard screws, indicated by the small keyboard icons.

![Keyboard screws](./img/keyboard-screws.png)

3. Open the Lemur and place it on its side.
4. Push the screwdriver into the keyboard push point until the keyboard pops out.

![Keyboard push point](./img/path-to-file)

5. Set the Lemur down, then starting from the top side, pull the keyboard loose.

![Keyboard removal](./img/path-to-file)

6. Flip the keyboard over onto the trackpad.

![Keyboard flip](./img/path-to-file)
...
14. Flip the Lemur over.
15. Replace the 2 screws holding the keyboard in place.
16. Boot your Lemur and confirm the keyboard is operational.
...
M.2 SSDs offer, at minimum, SATA III speeds and performance in a package about the size of a stick of gum. NVMe M.2 SSDs offer even higher performance. The Lemur supports **[CHECK}** two M.2 SSDs, size 2280, either M.2 SATA or NVMe M.2 PCIe Generation 3.
...
Your Lemur's WiFi and Bluetooth are both handled by the same module. It is a standard M.2 2230 slot with PCIe and USB interfaces (A Key).
