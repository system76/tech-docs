...
Thelio Mira B4-N3 contains two CPU fans. The back fan is mounted on the CPU duct, and the middle fan is mounted within the CPU heatsink.
...
Named after Jupiter's moon Io, the Thelio Io daughterboard handles the front power button and fan control. Thelio Spark B1-N2 uses [Thelio Io version 2.3](https://github.com/system76/thelio-io/tree/92c2a60b6d6acc0f9d51d819cba07ad28e2b03f3). If the Thelio Io board becomes defective, it can be replaced using the instructions below.
...
6. Plug the 4-pin Berg power connector and SATA data cables into the SATA backplane.
    ...
    - Ensure the cables are not plugged into SATA ports 2 and 3 (the bottom two ports), as these ports are unavailbable when the M.2 slots are fully populated.
