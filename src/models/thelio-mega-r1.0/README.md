...
- GPU options
    - Up to four GPUs, depending on configuration (2x PCIe 3.0 x16 and 2x PCIe 3.0 x8)
...
- Networking
    - 2x 10-Gigabit Ethernet (Intel 10GbE LAN chip)
        - Combined total is 10Gbit; ports will run at 5Gbit if used at the same time.
    - Wi-Fi 6 (Intel AX200)
- Power
